	...
	<div id="main">
		<div class="inner">
			...
			<div class="post">
				<!-- Form -->
				<h2 class="title">
					자주 묻는 질문 <a href="${cp}/faq/FAQ.fq" class="button alt"
						style="font-size: 15px; font-weight: 700; margin-left: 160px;">전체
						목록</a>
				</h2>
				<form method="post">
					<div class="row gtr-uniform">
						<div class="col-6 col-12-xsmall" id="manager_name">
							<input type="text" name="manager" id="manager"
								value="${faq.title}" readonly/>
						</div>
						<!-- Break -->
						<div class="col-12">
							<textarea name="textarea" id="textarea" rows="17" readonly>${faq.content}</textarea>
						</div>
					</div>
				</form>
			</div>
