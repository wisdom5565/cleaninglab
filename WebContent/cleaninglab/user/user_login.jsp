...
<body class="is-preload">
	...
	<div id="main">
		<div class="inner">
			...
			<div id="wrap">
				<p>회원로그인</p>
				<form name="loginForm" action="${cp}/user/UserLoginOk.us"
					method="post" onsubmit="return sendit()">
					<input type="text" name="useremail" placeholder="이메일을 입력하세요"
						value=${param.usereamil != null?param.useremail:''}> <input
						type="password" name="userpw" placeholder="비밀번호를 입력하세요">
					<p class="find">
						<a href="${cp}/user/FindEmail.us">이메일 찾기</a> | <a
							href="${cp}/user/FindPw.us">비밀번호찾기</a>
					</p>
...
<script>
	let idTag = document.loginForm.useremail;
