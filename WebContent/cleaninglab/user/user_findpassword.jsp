...
<body class="is-preload">
	...
	<div class="inner">
		...
		<form name="FindPasswordForm" action="${cp}/user/ChangePwOk.us"
			...
			<table style="text-align: center;">
				...
				<tr>
					...
					<td><input type="password" name="userpw_re"
...
<script>
	function sendit() {
		let emailTag = document.FindPasswordForm.useremail;
		let phoneTag = document.FindPasswordForm.userphone;
		let pwTag = document.FindPasswordForm.userpw;
		let pw_reTag = document.FindPasswordForm.userpw_re;
	...
	function findPw() {
		var useremail = document.FindPasswordForm.useremail.value;
		...
		// 통신할 곳과의 연결 통로 열기
		xhr.open("GET", cp + "/user/FindPwOk.us?useremail=" + useremail, true);
