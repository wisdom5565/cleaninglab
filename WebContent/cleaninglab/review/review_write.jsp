...
<c:if test="${loginUser == null}">
	...
	<div id="main">
		<div class="inner">
			<div class="post">
				<h2 class="title">리얼후기 작성</h2>
				<form method="post" name="reviewForm"
					action="${cp}/review/ReviewWriteOk.re">
					<input type="hidden" name="renum" id="renum" value="${param.renum}">
					...
					<div class="row gtr-uniform">
						...
						<div class="col-6 col-12-xsmall" id="manager_name" style="padding-top: 10px;">
							<input type="text" name="name" id="name" value="${param.name } 매니저님"
								placeholder="매니저명" readonly />
						</div>
						<div class="col-6 col-12-xsmall" id="manager_name"
							style="padding-top: 15px;">
							<h4 style="font-weight: bold; margin-bottom: 15px;">제목</h4>
							<input type="text" name="title" id="title"
								value="" placeholder="리뷰 제목" />
						</div>
						...
						<div class="col-12">
							<ul class="actions fixed">
								<li><input type="submit" value="작성하기" id="button"
									onclick="sendit();" /></li>
